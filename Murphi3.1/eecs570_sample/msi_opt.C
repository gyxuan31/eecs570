...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  mu_1_MessageType (char *name, int os): mu__byte(8, 21, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(8, 21, 4) {};
  mu_1_MessageType (int val): mu__byte(8, 21, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_MessageType::values[] = {"GetS","GetM","PutS","PutM","PutE","FwdGetS","FwdGetM","PutAck","Inv","InvAck","Data","ExData","Downgrade","DgdAck",NULL };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(22, 26, 3, name, os) {};
  mu_1__type_0 (void): mu__byte(22, 26, 3) {};
  mu_1__type_0 (int val): mu__byte(22, 26, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_0::values[] = {"H_M","H_S","H_I","H_SD","H_E",NULL };
...
char *mu_1__type_2::values[] = {"P_M","P_S","P_I","P_ISD","P_IMAD","P_IMA","P_SMAD","P_SMA","P_MIA","P_SIA","P_IIA","P_E","P_EIA",NULL };
...
void mu_1_ProcState::set_self(char *n, int os)
{
  ...
  mu_cnt.set_self_2(name, ".cnt", os + 16 );
}
...
void mu_1__type_5::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"HomeType", i * 432 + os);i++;
array[i].set_self_ar(n,"Proc_1", i * 432 + os);i++;
array[i].set_self_ar(n,"Proc_2", i * 432 + os);i++;
array[i].set_self_ar(n,"Proc_3", i * 432 + os);i++;
}
...
const int mu_HomeType = 7;
const int mu_GetS = 8;
const int mu_GetM = 9;
const int mu_PutS = 10;
const int mu_PutM = 11;
const int mu_PutE = 12;
const int mu_FwdGetS = 13;
const int mu_FwdGetM = 14;
const int mu_PutAck = 15;
const int mu_Inv = 16;
const int mu_InvAck = 17;
const int mu_Data = 18;
const int mu_ExData = 19;
const int mu_Downgrade = 20;
const int mu_DgdAck = 21;
const int mu_H_M = 22;
const int mu_H_S = 23;
const int mu_H_I = 24;
const int mu_H_SD = 25;
const int mu_H_E = 26;
const int mu_P_M = 27;
const int mu_P_S = 28;
const int mu_P_I = 29;
const int mu_P_ISD = 30;
const int mu_P_IMAD = 31;
const int mu_P_IMA = 32;
const int mu_P_SMAD = 33;
const int mu_P_SMA = 34;
const int mu_P_MIA = 35;
const int mu_P_SIA = 36;
const int mu_P_IIA = 37;
const int mu_P_E = 38;
...
/*** Variable declaration ***/
mu_1__type_7 mu_InBox("InBox",1944);
...
return mu_Total;
  Error.Error("The end of function CountSharer reached without returning values.");
};
/*** end function declaration ***/
...
mu_Send ( mu_Inv, mu_n, mu_rqst, mu_VC2, mu_1_Value_undefined_var, mu__intexpr15 );
}
}
};
};
...
case mu_GetS:
mu_Send ( mu_ExData, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_HomeNode.mu_val, 0 );
...
break;
case mu_PutS:
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC1, mu_1_Value_undefined_var, 0 );
break;
case mu_PutM:
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC1, mu_1_Value_undefined_var, 0 );
break;
...
mu_HomeNode.mu_state = mu_H_M;
bool mu__boolexpr17;
  if (!(mu_IsSharer( mu_msg.mu_src ))) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = ((mu_cnt) == (1)) ; 
}
if ( mu__boolexpr17 )
{
...
{
bool mu__boolexpr18;
  if (!(!(mu_IsSharer( mu_msg.mu_src )))) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = ((mu_cnt) != (0)) ; 
}
if ( mu__boolexpr18 )
{
...
{
mu_Send ( mu_Data, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_1_Value_undefined_var, (mu_cnt) - (1) );
mu_SendInvReqToSharers ( mu_msg.mu_src );
}
}
break;
case mu_PutS:
bool mu__boolexpr19;
  if (!(mu_IsSharer( mu_msg.mu_src ))) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = ((mu_cnt) == (1)) ; 
}
if ( mu__boolexpr19 )
{
...
case mu_PutM:
bool mu__boolexpr20;
  if (!(mu_IsSharer( mu_msg.mu_src ))) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = ((mu_cnt) == (1)) ; 
}
if ( mu__boolexpr20 )
{
mu_HomeNode.mu_state = mu_H_I;
...
switch ((int) mu_msg.mu_mtype) {
case mu_GetS:
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC2, mu_1_Value_undefined_var, (int)mu_cnt );
mu_AddToSharersList ( mu_HomeNode.mu_owner );
mu_AddToSharersList ( mu_msg.mu_src );
mu_HomeNode.mu_owner.undefine();
mu_HomeNode.mu_state = mu_H_SD;
break;
case mu_GetM:
mu_Send ( mu_FwdGetM, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC2, mu_1_Value_undefined_var, 0 );
mu_HomeNode.mu_owner = mu_msg.mu_src;
break;
case mu_PutS:
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC0, mu_1_Value_undefined_var, 0 );
mu_RemoveFromSharersList ( mu_msg.mu_src );
break;
case mu_PutM:
if ( (mu_msg.mu_src) == (mu_HomeNode.mu_owner) )
...
if ( (mu_msg.mu_src) == (mu_HomeNode.mu_owner) )
{
mu_Send ( mu_DgdAck, mu_HomeNode.mu_owner, (int)mu_HomeType, mu_VC1, mu_1_Value_undefined_var, 0 );
mu_AddToSharersList ( mu_HomeNode.mu_owner );
mu_HomeNode.mu_owner.undefine();
mu_HomeNode.mu_state = mu_H_SD;
}
...
switch ((int) mu_msg.mu_mtype) {
case mu_GetS:
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC2, mu_1_Value_undefined_var, 0 );
mu_AddToSharersList ( mu_HomeNode.mu_owner );
mu_AddToSharersList ( mu_msg.mu_src );
mu_HomeNode.mu_owner.undefine();
mu_HomeNode.mu_state = mu_H_SD;
...
{
  mu_1_Count& mu_pc = mu_Procs[mu_p].mu_cnt;
switch ((int) mu_ps) {
case mu_P_I:
switch ((int) mu_msg.mu_mtype) {
case mu_Inv:
mu_Send ( mu_InvAck, mu_msg.mu_src, (int)mu_p, mu_VC2, mu_1_Value_undefined_var, 0 );
break;
default:
...
{
bool mu__boolexpr21;
  if ((mu_msg.mu_cnt) <= (0)) mu__boolexpr21 = TRUE ;
  else {
  mu__boolexpr21 = (((mu_msg.mu_cnt) + (mu_pc)) <= (0)) ; 
}
if ( mu__boolexpr21 )
{
mu_pc = 0;
...
break;
case mu_P_M:
mu_Send ( mu_Downgrade, (int)mu_HomeType, (int)mu_p, mu_VC2, mu_1_Value_undefined_var, 0 );
switch ((int) mu_msg.mu_mtype) {
case mu_DgdAck:
mu_ps = mu_P_S;
...
/*** end multisetcount 8 declaration ***/
  ...
  void NextRule(unsigned & what_rule)
  {
    ...
    mu_n.unionassign(r % 4);
    r = r / 4;
    while (what_rule < 24 && mu_midx.value()<6 )
      {
...
bool mu__boolexpr30;
bool mu__boolexpr31;
  if ((mu_msg.mu_vc) == (mu_VC2)) mu__boolexpr31 = TRUE ;
  else {
bool mu__boolexpr32;
  if (!((mu_msg.mu_vc) == (mu_VC1))) mu__boolexpr32 = FALSE ;
  else {
/*** begin multisetcount 6 declaration ***/
  int mu__intexpr33 = 0;
  {
  ...
  for (mu_m = 0; ; mu_m=mu_m+1)
    {
      if (mu_chan.valid[(int)mu_m].value())
        {
          if ( (mu_chan[mu_m].mu_vc) == (mu_VC2) ) mu__intexpr33++;
        }
      if (mu_m == 6-1) break;
    }
  }
...
bool mu__boolexpr34;
bool mu__boolexpr35;
  if (!((mu_msg.mu_vc) == (mu_VC0))) mu__boolexpr35 = FALSE ;
  else {
/*** begin multisetcount 7 declaration ***/
  int mu__intexpr36 = 0;
  {
  ...
  for (mu_m = 0; ; mu_m=mu_m+1)
    {
      if (mu_chan.valid[(int)mu_m].value())
        {
          if ( (mu_chan[mu_m].mu_vc) == (mu_VC2) ) mu__intexpr36++;
        }
      if (mu_m == 6-1) break;
    }
  }
  ...
  for (mu_m = 0; ; mu_m=mu_m+1)
    {
      if (mu_chan.valid[(int)mu_m].value())
        {
          if ( (mu_chan[mu_m].mu_vc) == (mu_VC1) ) mu__intexpr37++;
        }
      if (mu_m == 6-1) break;
    }
  }
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("PutE when P_E, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutE, (int)mu_HomeType, (int)mu_n, mu_VC0, mu_p.mu_val, 0 );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("PutM when P_M, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store new value when P_M, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("PutS when P_S, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store new value when P_E, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store new value when P_S, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_GetM, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_1_Value_undefined_var, 0 );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("store new value when P_I, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("read request when P_I, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_GetS, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_1_Value_undefined_var, 0 );
...
const unsigned numrules = 96;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 96
...
/********************
  Invariant records
 ********************/
int mu__invariant_38() // Invariant "values in shared state match memory"
{
bool mu__quant39; 
mu__quant39 = TRUE;
{
...
bool mu__boolexpr40;
bool mu__boolexpr41;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr41 = FALSE ;
  else {
  mu__boolexpr41 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = TRUE ;
  else {
  mu__boolexpr40 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr40) )
...
bool mu__condition_42() // Condition for Rule "values in shared state match memory"
{
...
int mu__invariant_43() // Invariant "values in memory matches value of last write, when shared or invalid"
{
bool mu__quant44; 
mu__quant44 = TRUE;
{
...
bool mu__boolexpr45;
bool mu__boolexpr46;
  if ((mu_HomeNode.mu_state) == (mu_H_S)) mu__boolexpr46 = TRUE ;
  else {
  mu__boolexpr46 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
...
bool mu__condition_47() // Condition for Rule "values in memory matches value of last write, when shared or invalid"
{
...
{
bool mu__boolexpr53;
  if (!((mu_HomeNode.mu_state) == (mu_H_M))) mu__boolexpr53 = TRUE ;
  else {
...
int mu__invariant_56() // Invariant "values in caches P_S P_M state match last write"
{
bool mu__quant57; 
mu__quant57 = TRUE;
{
...
bool mu__boolexpr58;
bool mu__boolexpr59;
  if ((mu_Procs[mu_n].mu_state) == (mu_P_S)) mu__boolexpr59 = TRUE ;
  else {
  mu__boolexpr59 = ((mu_Procs[mu_n].mu_state) == (mu_P_M)) ; 
}
...
bool mu__condition_60() // Condition for Rule "values in caches P_S P_M state match last write"
{
...
int mu__invariant_61() // Invariant "value in memory matches value of last write, when H_S H_I"
{
bool mu__boolexpr62;
bool mu__boolexpr63;
  if ((mu_HomeNode.mu_state) == (mu_H_I)) mu__boolexpr63 = TRUE ;
  else {
  mu__boolexpr63 = ((mu_HomeNode.mu_state) == (mu_H_S)) ; 
}
...
bool mu__condition_64() // Condition for Rule "value in memory matches value of last write, when H_S H_I"
{
...
{
bool mu__boolexpr66;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr66 = TRUE ;
  else {
...
{"value in memory matches value of last write, when H_S H_I", &mu__condition_64, NULL, FALSE},
{"values in caches P_S P_M state match last write", &mu__condition_60, NULL, FALSE},
...
{"values in memory matches value of last write, when shared or invalid", &mu__condition_47, NULL, FALSE},
{"values in shared state match memory", &mu__condition_42, NULL, FALSE},
};
