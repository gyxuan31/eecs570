...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  mu_1_MessageType (char *name, int os): mu__byte(8, 19, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(8, 19, 4) {};
  mu_1_MessageType (int val): mu__byte(8, 19, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_MessageType::values[] = {"GetS","GetM","PutS","PutM","PutE","FwdGetS","FwdGetM","PutAck","Inv","InvAck","Data","ExData",NULL };
...
class mu_1__type_0: public mu__byte
{
 public:
  ...
  mu_1__type_0 (char *name, int os): mu__byte(20, 24, 3, name, os) {};
  mu_1__type_0 (void): mu__byte(20, 24, 3) {};
  mu_1__type_0 (int val): mu__byte(20, 24, 3, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
class mu_1__type_2: public mu__byte
{
 public:
  ...
  mu_1__type_2 (char *name, int os): mu__byte(25, 37, 4, name, os) {};
  mu_1__type_2 (void): mu__byte(25, 37, 4) {};
  mu_1__type_2 (int val): mu__byte(25, 37, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const int mu_H_S = 21;
const int mu_H_I = 22;
const int mu_H_SD = 23;
const int mu_H_E = 24;
const int mu_P_M = 25;
const int mu_P_S = 26;
const int mu_P_I = 27;
const int mu_P_ISD = 28;
const int mu_P_IMAD = 29;
const int mu_P_IMA = 30;
const int mu_P_SMAD = 31;
const int mu_P_SMA = 32;
const int mu_P_MIA = 33;
const int mu_P_SIA = 34;
const int mu_P_IIA = 35;
const int mu_P_E = 36;
const int mu_P_EIA = 37;
...
/*** Variable declaration ***/
mu_1__type_7 mu_InBox("InBox",1368);

/*** Variable declaration ***/
mu_0_boolean mu_msg_processed("msg_processed",2136);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",2144);
...
const unsigned numrules = 88;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 88
